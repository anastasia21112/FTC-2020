...
@Autonomous(name = "LeftLineBot Far Beginning", group = "LinearOpMode")
public class LeftLineBotFar extends LinearOpMode{
    ...
    public void park(double power, int distance)
    {
        ...
        driveForwardEncoders(0.5, 2500);
        strafeLeftEncoders(power, distance);
    }
