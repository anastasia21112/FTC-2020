...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        FL = hardwareMap.dcMotor.get(verticalLeftEncoderName);
        FR = hardwareMap.dcMotor.get(verticalRightEncoderName);
        BR = hardwareMap.dcMotor.get(horizontalEncoderName);
        ...
        */
        ...
        OdometryGlobalCoordinatePosition globalPositionUpdate = new OdometryGlobalCoordinatePosition(FL, FR, BR, COUNTS_PER_INCH, 75);
