...
public class OdometryGlobalCoordinatePosition implements Runnable{
     ...
     * @param FL left odometry encoder, facing the vertical direction
     * @param  FR right odometry encoder, facing the vertical direction
     * @param  BR horizontal odometry encoder, perpendicular to the other two odometry encoder wheels
     * @param threadSleepDelay delay in milliseconds for the GlobalPositionUpdate thread (50-75 milliseconds is suggested)
     */
    public OdometryGlobalCoordinatePosition(DcMotor FL, DcMotor FR, DcMotor BR, double COUNTS_PER_INCH, int threadSleepDelay){
        this.FL = FL;
        this.FR = FR;
        this.BR = BR;
    ...
    private void globalCoordinatePositionUpdate(){
        ...
        verticalLeftEncoderWheelPosition = (FL.getCurrentPosition() * verticalLeftEncoderPositionMultiplier);
        verticalRightEncoderWheelPosition = (FR.getCurrentPosition() * verticalRightEncoderPositionMultiplier);
        ...
        normalEncoderWheelPosition = (BR.getCurrentPosition()*normalEncoderPositionMultiplier);
