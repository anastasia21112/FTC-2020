...
@Autonomous
public class BlueAllianceSkystoneAuto extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        while(opModeIsActive())
        {
            ...
            if(skystoneDetector.stoneFourisSkystone())
            {
                strafeRightEncoders(0.2, 500);
                driveForwardEncoders(1.0, 3500);
                driveForwardEncoders(0.5, 500);

                sleep(2000);
                //driveForwardEncoders(0.8, 1000);
                driveBackwardEncoders(-1.0, 5000);
                turnLeftEncoders(1.0, 1500);
                driveForwardEncoders(1.0, 4800);
                IR.setPower(-1.0);
                IL.setPower(1.0);
                sleep(1000);
                driveBackwardEncoders(-1.0, 4500);
                turnRightEncoders(1.0, 1300);
                driveForwardEncoders(0.8, 3500);
                sleep(2000);
                driveBackwardEncoders(-1.0, 5000);
                turnLeftEncoders(1.0, 1500);
                ...
                IL.setPower(1.0);
                sleep(1000);
                driveBackwardEncoders(-1.0, 1800);
